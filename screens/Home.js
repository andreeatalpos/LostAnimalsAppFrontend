...
const Home = ({navigation}) => {
    ...
    const clearLogin = () => {
        AsyncStorage
            .removeItem('currentUserCredentials')
            .then(() => {
    ...
    return (
        <>
            ...
            <InnerContainer>
                ...
                <HomeContainer>
                    <PageTitle home={true}>Welcome, {fullName || 'James Smith'}!</PageTitle>
                   <SubTitle home={true}>{'Helping you to reunite with your furry friend'}</SubTitle>
